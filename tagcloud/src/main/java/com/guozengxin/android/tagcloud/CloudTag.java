...
public class CloudTag {
	...
	public CloudTag(String text, int color) {
	...
	public CloudTag(String text, String color) {
	...
	public CloudTag(int id, String text) {
	...
	public CloudTag(int id, String text, int color) {
	...
	public CloudTag(int id, String text, String color) {
